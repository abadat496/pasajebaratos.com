          ...
          <div className="row">
            ...
            >
              ...
              >
                ...
                <div className="row">
                  <div className="col-12 col-sm-4 col-lg-6 col-xl-6 p-2">
                  ...
                  <div className="col-6 col-sm-4 col-lg-3 col-xl-3 p-2">
                  ...
                  <div className="col-12 col-sm-4 col-lg-3 col-xl-3 p-2">
                  ...
                  <div className="col-12 col-sm-4 col-lg-3 col-xl-3 d-grid gap-2 p-2">
                    <button
                      className="btn btn-primary"
                      type="button"
                      onClick={handleSubmit}
                    >
                    <i className="fa-solid fa-magnifying-glass ml-2"></i>   BUSCAR VUELOS 
                    </button>
                  </div>
                </div>
                {!isValid && (
